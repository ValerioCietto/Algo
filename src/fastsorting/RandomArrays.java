...
public class RandomArrays {
	...
	/*
	 * genera un array di interi (int) casuali con probabilità uniforme dal
	 * minimo al massimo valore intero possibile
	 */
	...
	/*
	 * genera un array di int casuali con probabilità uniforme da 0 fino a max
	 * incluso
	 */
	...
	/*
	 * riempie di int casuali con probabilità uniforme da 0 fino a max incluso
	 * una porzione da 0 a n-1 di array già allocato
	 */
	...
	/**
	 * genera un array di int casuali compresi fra min e max, estremi inclusi
	 */
	public static int[] randomIntArray(int lungh, int min, int max) {
		int range = max + 1 - min;
		if (range < 0)
			throw new IllegalArgumentException("range troppo grande");
		int[] a = new int[lungh];
		for (int i = 0; i < lungh; i++) {
	...
	/**
	 * genera un array di Integer casuali compresi fra min e max, estremi
	 * inclusi
	 */
	...
	/**
	 * genera un array di Double casuali compresi fra min e max, estremi inclusi
	 */
	...
	/**
	 * genera una stringa casuale di lettere minuscole, di lunghezza casuale
	 * minore o uguale a una lunghezza massima data
	 */
	...
	/**
	 * genera una array di lunghezza lungh, di stringhe casuali di lettere
	 * minuscole di lunghezza minore o uguale maxLunghString
	 */
	...
	/**
	 * crea un array di stringhe leggendo da un file di testo, dove ogni riga è
	 * una stringa
	 */
	...
	/**
	 * crea un array di stringhe estratte a caso da un elenco di stringhe
	 * memorizzato in un file di testo (un "dizionario")
	 */
